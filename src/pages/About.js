...
function About(){
    return (
        <div className={style.main}>
            ...
            <p className={style.about}>I am a dedicated student with a fervent passion for  machine learning, and cloud computing. My proficiency in Java programming, data structures, and algorithms has allowed me to excel in coding. I possess a good understanding of front-end development, enhancing my versatility.

                What sets me apart is my creative aptitude for innovation and problem-solving. I've completed real-time projects during my academic journey, providing valuable insights into addressing real-world issues. I have an unceasing enthusiasm for continuous learning and skill acquisition.

                In the realm of sports, I've actively participated in district-level wushu competitions and captained my school's cricket team, demonstrating leadership and teamwork. Beyond academics and sports, I'm an avid enthusiast of bike racing and trekking, reflecting my adventurous spirit. My deep passion for nature and its beauty provides solace and fuels my commitment to environmental sustainability.</p>
           ...
           <div className={style.skills}>
            ...
            <div>
                <ul className={style.skills}>
                    ...
                    <li className={style.skillsItem}>
                        <FontAwesomeIcon icon={faBootstrap} className={style.sassLogo} />
                        #Bootstrap
                    </li>
                    <li className={style.skillsItem}>
                    ...
                    <li className={style.skillsItem}>
                        <FontAwesomeIcon icon={faCss3Alt} className={style.sassLogo} />
                        #css
                    </li>
                    <li className={style.skillsItem}>
                        #MongoDB
           ...
           <div className={style.ppp}>
                ...
                <div className={style.flex}>
                    <div className={style.profle}>
                        ...
                        <div>
                            <h2>HACKER RANK</h2>
                            <h3>"I have successfully solved No-SQL and DSA problems, achieving a 3-⭐  in No-SQL."</h3>
                        </div>
                    </div>
                    <div className={style.profle}>
                        ...
                        <div>
                            <h2>LeetCode</h2>
                            <h3>"I have solved more than 250 problems and posted over 10 solutions, achieving a rank of 246,327"</h3>
                        </div>
                    </div>
                    <div className={style.profle}>
                        ...
                        <div>
                            <h2>Git Hub</h2>
                            <h3>"I have a strong understanding of Git and GitHub skills. I have posted all my projects and have 20 repositories on GitHub."</h3>
                        </div>
                    ...
                    <div className={style.profle}>
                        ...
                        <div>
                            <h2>GFG</h2>
                            <h3>"I have participated in most of the coding challenges, solved all the basic and advanced DSA (Data Structures and Algorith ms) problems on this profile, and achieved a good rank in the college coding challenges."</h3>
                        </div>
                    ...
                    <div className={style.profle}>
                        ...
                        <div>
                            <h2>Dribble</h2>
                            <h3>"Just Started My journey Using the Dribble Posted fre Front end Web_Designs"</h3>
                        </div>
